...
text\<open>The (sub-)sections are presented in the topological order of the dependencies of the underlying theory code.
...
and documents tools for parsing, analyzing and transforming routing tables.\<close>
...
transformation of routing tables to mappings for reverse path filtering.\<close>
text\<open>The goal of sections \ref{sec:routing,sec:rpf} is to produce a relation that describes 
the relation between interfaces and what set of IP addresses are allowed or expected to appear on these interfaces.\<close>
text\<open>Based upon that and \todo{cite}, Section \ref{sec:irew} shows a method to refine the analysis of firewall rulesets
